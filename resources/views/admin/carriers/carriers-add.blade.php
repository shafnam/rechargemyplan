            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Add New Carrier</h3>
                    </div>
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form role="form" id="carrier_add_form" action="{{ route('admin.carriers.add.post') }}" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                        <div class="box-body">
                            <div class="row">
                                <div class="form-group col-md-6">
                                    <label>Carrier Name*</label>
                                    <input type="text" name="carrier_name" id="carrier_name" class="form-control" placeholder="Enter ..." required>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-md-6">
                                    <label>Description</label>
                                    <textarea name="carrier_description" id="carrier_description" class="form-control" rows="3" placeholder="Enter ..."></textarea>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-md-6 img-upload">
                                    <div class="row">
                                        ...
                                        <img id="img_preview" class="col-md-4" alt="carrier image" src="{{URL::asset('/images/carriers/carrier-preview.png')}}"/>
